...
DEVICE = 'cuda'
DATA_PATH = '/home/aneeshashmi/xai/XAIM/clf_results_imgs' #Updated the data path. Picking only correctly classified samples
...
def load_images(data_path, transform, class_n, device='cuda'):
    images = []
    for img_path in tqdm(os.path.join(data_path, class_n)):
        print("aaaa")
        print(data_path, class_n, img_path)
        print("aaaa")
        print(os.path.join(data_path, class_n, img_path))
        print("aaaa")
