...
def main(DATA_PATH, split="testing"):
    ...
    for eps in [0.03, 0.06, 0.01]:
        for attack in ['PDG', 'FGSM']:
            ...
            save_dir_succ_x = f"./data4/{split}/{attack}_{eps}/{class_name}/Succ/Succ_x/"
            save_dir_succ_clean_x = f"./data4/{split}/{attack}_{eps}/{class_name}/Succ/Clean_x/"
            save_dir_unsucc_N_x = f"./data4/{split}/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x/"
            save_dir_unsucc_clean_N_x = f"./data4/{split}/{attack}_{eps}/{class_name}/Unsucc/Clean_x/"
            
            save_dir_succ_x_attn = f"./data4/{split}/{attack}_{eps}/{class_name}/Succ/Succ_x_attn/"
            save_dir_succ_clean_x_attn = f"./data4/{split}/{attack}_{eps}/{class_name}/Succ/Clean_x_attn/"
            save_dir_unsucc_N_x_attn = f"./data4/{split}/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x_attn/"
            save_dir_unsucc_clean_N_x_attn = f"./data4/{split}/{attack}_{eps}/{class_name}/Unsucc/Clean_x_attn/"
