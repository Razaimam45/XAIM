...
def main(DATA_PATH, split="testing"):
    ...
    for eps in [0.03, 0.06, 0.01]:
        for attack in ['PDG', 'FGSM']:
            ...
            succ_imgs, succ_attns, unsucc_imgs, unsucc_attns, clean_succ_x, clean_unsucc_N_x, clean_succ_x_attns, clean_unsucc_N_x_attns, success_imgs_name, unsuccess_imgs_name = get_success_unsuccess_adv_images(adv_images_test_normal, pred_i, image_test_normal, model=model, image_name_list=normal_testing_filenames)
