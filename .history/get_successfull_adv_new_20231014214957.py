...
def main(DATA_PATH, split="testing"):
    ...
    for eps in [0.03, 0.06, 0.01]:
        for attack in ['PDG', 'FGSM']:
            ...
            # print(f'Running {attack} for Epsilon = {eps} on Test {class_name}')
            # if attack == 'PDG':
            ...
            # succ_imgs, succ_attns, unsucc_imgs, unsucc_attns, clean_succ_x, clean_unsucc_N_x, clean_succ_x_attns, clean_unsucc_N_x_attns, success_imgs_name, unsuccess_imgs_name = get_success_unsuccess_adv_images(
            #     adv_images_test_normal, 
            #     pred_i, 
            #     image_test_normal, 
            #     model=model, 
            #     image_name_list=normal_testing_filenames
            #     )
            
            # save_dir_succ_x = f"./data5/{split}/{attack}_{eps}/{class_name}/Succ/Succ_x/"
            # save_dir_succ_clean_x = f"./data5/{split}/{attack}_{eps}/{class_name}/Succ/Clean_x/"
            # save_dir_unsucc_N_x = f"./data5/{split}/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x/"
            # save_dir_unsucc_clean_N_x = f"./data5/{split}/{attack}_{eps}/{class_name}/Unsucc/Clean_x/"
            
            # save_dir_succ_x_attn = f"./data5/{split}/{attack}_{eps}/{class_name}/Succ/Succ_x_attn/"
            # save_dir_succ_clean_x_attn = f"./data5/{split}/{attack}_{eps}/{class_name}/Succ/Clean_x_attn/"
            # save_dir_unsucc_N_x_attn = f"./data5/{split}/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x_attn/"
            # save_dir_unsucc_clean_N_x_attn = f"./data5/{split}/{attack}_{eps}/{class_name}/Unsucc/Clean_x_attn/"
            ...
            succ_imgs, succ_attns, unsucc_imgs, unsucc_attns, clean_succ_x, clean_unsucc_N_x, clean_succ_x_attns, clean_unsucc_N_x_attns, success_imgs_name, unsuccess_imgs_name = get_success_unsuccess_adv_images(
                                                                                                        ...
                                                                                                        image_test_tb, 
                                                                                                        model=model, 
                                                                                                        image_name_list = tb_testing_filenames)
                                                                                                    
            save_dir_succ_x = f"./data5/{attack}_{eps}/{class_name}/Succ/Succ_x/"
            save_dir_succ_clean_x = f"./data5/{attack}_{eps}/{class_name}/Succ/Clean_x/"
            save_dir_unsucc_N_x = f"./data5/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x/"
            save_dir_unsucc_clean_N_x = f"./data5/{attack}_{eps}/{class_name}/Unsucc/Clean_x/"
            
            save_dir_succ_x_attn = f"./data5/{attack}_{eps}/{class_name}/Succ/Succ_x_attn/"
            save_dir_succ_clean_x_attn = f"./data5/{attack}_{eps}/{class_name}/Succ/Clean_x_attn/"
            save_dir_unsucc_N_x_attn = f"./data5/{attack}_{eps}/{class_name}/Unsucc/Unsucc_x_attn/"
            save_dir_unsucc_clean_N_x_attn = f"./data5/{attack}_{eps}/{class_name}/Unsucc/Clean_x_attn/"
