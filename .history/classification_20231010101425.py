...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="/home/aneeshashmi/xai/vit_base_patch16_224_in21k_test-accuracy_0.96_chest.pth" type=str, required=True)
    parser.add_argument("--data_path", default=DATA_DIR, type=str, required=True)
    ...
    val_data, val_img_names = get_data(os.path.join(args.data_path, "validation"), args.device)
