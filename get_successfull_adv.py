...
device = 'cuda'
data_path = '/home/raza.imam/Documents/XAIM/XAIM/correct_data' #Updated the data path. Picking only correctly classified samples
...
def get_success_unsuccess_adv_images (adv_images_list, cls_idx, clean_images, image_name_list=None):
    success_imgs = []
    success_imgs_name = []
    unsuccess_imgs = []
    ...
    return success_imgs, success_imgs_attns, unsuccess_imgs, unsuccess_imgs_attns, clean_succ_x, clean_unsucc_N_x,  clean_succ_x_attns, clean_unsucc_N_x_attns, success_imgs_name, unsuccess_imgs_name

# -------------------------------------- # 
# %%
def correctly_classified_images(images_all, cls_idx):
    correct_imgs = []
...
#For saving the correctly classified test samples.

# for Normal class
# class_name = 'Normal'      
# pred_i = 0 # 0 --> Normal, 1 --> TB
# print(classes[pred_i])
# correctly_classified_images(image_test_normal, pred_i)

# for TB class
# class_name = 'TB'      
# pred_i = 1 # 0 --> Normal, 1 --> TB
# print(classes[pred_i])
# correctly_classified_images(image_test_tb, pred_i)
