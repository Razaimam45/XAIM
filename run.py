...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_train_imgs", type=int, default=500, help="number of train images to use") # 2000
    ...
    parser.add_argument("--test", default=False, choices=[True, False], help="Either to perform testing as well or just save and exit")
    # mean attacks
